...
'''
Usage: score_by_dict.py [source] [dictionary]
'''
...
#preprocessing
tokens = nltk.wordpunct_tokenize(raw_text.decode('utf8', 'ignore'))
...
print engltextlemmas
print engldiclemmas
print sum(englfreqlist)
